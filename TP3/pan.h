...
#define _nstates2	85	/* client */
#define minseq2	134
#define maxseq2	217
#define _endstate2	84

#define _nstates1	115	/* server */
#define minseq1	20
#define maxseq1	133
#define _endstate1	114

#define _nstates0	21	/* database */
#define minseq0	0
#define maxseq0	19
...
typedef struct P3 { /* :init: */
	...
	unsigned _priority : 8; /* 0..255 */
#endif
	uchar clientToServerChan;
	uchar serverToClientChan;
	uchar serverToDatabaseChan;
	uchar databasetoServerChan;
} P3;
#define Air3	(sizeof(P3) - Offsetof(P3, databasetoServerChan) - 1*sizeof(uchar))

#define Pclient	((P2 *)_this)
typedef struct P2 { /* client */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned returnToStartState : 1;
	uchar serverToClientChan;
	uchar clientToServerChan;
	uchar serverResponse;
} P2;
#define Air2	(sizeof(P2) - Offsetof(P2, serverResponse) - 1*sizeof(uchar))

#define Pserver	((P1 *)_this)
typedef struct P1 { /* server */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
	...
	uchar databasetoServerChan;
	uchar clientRequest;
	uchar databaseResponse;
	int uselessCreditInfo;
	int fkYou;
	int accountFunds;
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, accountFunds) - 1*sizeof(int))

#define Pdatabase	((P0 *)_this)
typedef struct P0 { /* database */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, serverCredit) - 1*sizeof(int))
